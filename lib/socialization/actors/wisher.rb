...
module Socialization
  module wisher
    ...
    included do
      ...
      #
      # @param [wishable] wishable the object to be wishd.
      # @return [Boolean]
      def wish!(wishable)
      ...
      # Returns all the wishables of a certain type that are wishd by self
      #
      ...
      alias :wishees :wishables

      # Returns a relation for all the wishables of a certain type that are wishd by self
      #
      # @params [wishable] klass the type of {wishable} you want
      # @params [Hash] opts a hash of options
      ...
      alias :wishees_relation :wishables_relation
    end
  end
end
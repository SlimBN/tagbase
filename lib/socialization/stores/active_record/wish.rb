module Socialization
  module ActiveRecordStores
    class Wish < ActiveRecord::Base
      ...
      scope :wishing,   lambda { |wishable| where(
      ...
      class << self
        ...
        def wishes?(wisher, wishable)
          !wish_for(wisher, wishable).empty?
        end

        # Returns an ActiveRecord::Relation of all the wishers of a certain type that are wishing  wishable
        ...
        # Returns all the wishers of a certain type that are wishing  wishable
      ...
      private
        def wish_for(wisher, wishable)
          wished_by(wisher).wishing( wishable)
        end
      end # class << self
